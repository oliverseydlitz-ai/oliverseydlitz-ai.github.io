...
function load({ html = 'index.html', app = 'app.js' } = {}) {
  ...
  const EXPORTS = ['Sanitize','CookieConsent','Agreement','DB','MemDB','Metrics','Store','CSVParser','Auth',
    ...
    'ImportFlow','Features','CloudDB','AccessibilityEnhancements','SmartRecommendations','Goals','SessionSharing','RetentionProbe','PracticeLog','RangeCard','SessionTags','FirstRun','consistencyScore','bagConsistency','facePath','faceAngle','faceRatio','spinLoft','spinAxisFrom',
