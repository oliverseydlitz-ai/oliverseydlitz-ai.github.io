...
function load({ html = 'index.html', app = 'app.js' } = {}) {
  ...
  const EXPORTS = ['Sanitize','CookieConsent','Agreement','DB','MemDB','Metrics','Store','CSVParser',
    ...
    'ImportFlow','Features','CloudDB','SmartRecommendations','Goals','SessionSharing','RetentionProbe','PracticeLog','consistencyScore','bagConsistency','facePath','faceAngle','faceRatio','spinLoft','spinAxisFrom',
