...
# The guide pages, generated by tools/build-guide-pages.js. The render scan
# loads each one at phone width; without the copy it would report MISSING.
rm -rf "$SITE/guides" && cp -r "$REPO/guides" "$SITE/guides" || exit 1
