...
`npm test` runs **80 suites**, all green. (`contrast.js` was shipped red by
...
State at handover: **80 suites, all green**, render scan exit 0 both with and
without `SM_NO_IO=1`, service worker at **v209**, 58 modules.
...
**80 test suites**, service worker **v209**. Deterministic auth, cloud sync
