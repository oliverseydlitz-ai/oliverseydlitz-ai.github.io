...
`npm test` runs **78 suites**, all green. (`contrast.js` was shipped red by
...
State at handover: **78 suites, all green**, render scan exit 0 both with and
without `SM_NO_IO=1`, service worker at **v206**, 58 modules.
...
**78 test suites**, service worker **v206**. Deterministic auth, cloud sync
