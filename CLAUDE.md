...
1. **Utilities (not modules — top-level functions and tables)**
   ...
   - Stats: `avg()`, `mean()`, `stdDev()` (sample form, ÷ n−1), `fmt()`, `consistencyScore()`,
...
without `SM_NO_IO=1`, service worker at **v216**, 58 modules.
...
**81 test suites**, service worker **v216**. Deterministic auth, cloud sync
