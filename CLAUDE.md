...
`npm test` runs **76 suites**, all green. (`contrast.js` was shipped red by
...
State at handover: **76 suites, all green**, render scan exit 0 both with and
without `SM_NO_IO=1`, service worker at **v201**, 58 modules.
...
**76 test suites**, service worker **v201**. Deterministic auth, cloud sync
