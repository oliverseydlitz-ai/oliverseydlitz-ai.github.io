...
`npm test` runs **75 suites**, all green. (`contrast.js` was shipped red by
...
without `SM_NO_IO=1`, service worker at **v197**, 58 modules.
...
**75 test suites**, service worker **v197**. Deterministic auth, cloud sync
