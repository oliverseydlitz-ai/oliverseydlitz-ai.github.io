...
`npm test` runs **70 suites**, all green. (`contrast.js` was shipped red by
...
State at handover: **70 suites, all green**, render scan exit 0 both with and
without `SM_NO_IO=1`, service worker at **v165**, 58 modules.
...
**70 test suites**, service worker **v165**. Deterministic auth, cloud sync
