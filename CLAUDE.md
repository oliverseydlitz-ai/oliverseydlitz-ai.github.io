...
`npm test` runs **79 suites**, all green. (`contrast.js` was shipped red by
...
State at handover: **79 suites, all green**, render scan exit 0 both with and
without `SM_NO_IO=1`, service worker at **v207**, 58 modules.
...
**79 test suites**, service worker **v207**. Deterministic auth, cloud sync
